      ...
      // JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, null, conn);
        ...
        public void presupuestoasignado(HttpServletResponse response, @RequestParam Integer cod_mes, @RequestParam Integer cod_area,@RequestParam Integer cod_subarea) throws Exception {
           ...
           public void presupuestoaprobado(HttpServletResponse response, @RequestParam Integer cod_mes, @RequestParam Integer cod_area,@RequestParam Integer cod_subarea) throws Exception {
              ...
              public void presupuestoclasificacion(HttpServletResponse response, @RequestParam Integer cod_mes, @RequestParam Integer cod_clasificacion) throws Exception {
